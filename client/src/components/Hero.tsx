        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">Perfect Job Matching with Personalized Learning, Your Way!</span>
            </motion.div>
            ...
            >
              Create a learning path that adapts to your strengths, interests, and aspirations. Step by step, we’re here to guide you forward And Achieve your dream Job.
